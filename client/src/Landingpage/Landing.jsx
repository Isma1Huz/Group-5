...
function Landing() {
  ...
  return (
    <>
     <div class="nav1">
      <h1>eLearning</h1>
      <button id="btns"><strong><Link to="/auth">Start Free Trial →</Link></strong> </button>
    ...
    <div class="textimg">
      ...
      <button class="reg"><Link to="/auth">Register  →</Link></button>
      <button class="log"><Link to="/auth">Login  →</Link></button>
      </div>
      <div id="imgg">
